...
const SettingsPage = () => {
  return (
    <div className="min-h-screen">
      ...
      {/* Hero */}
      <section className="h-[40vh] bg-foreground text-background flex items-end">
      ...
      <section className="section-padding">
        <div className="container-narrow max-w-3xl">
          <Tabs defaultValue="profile" className="space-y-8">
            <TabsList className="bg-transparent border-b border-border rounded-none w-full justify-start gap-8 p-0 h-auto">
              <TabsTrigger 
                value="profile" 
            ...
            <TabsContent value="profile" className="space-y-8 mt-8">
              ...
              <button className="px-8 py-3 bg-foreground text-background text-sm uppercase tracking-widest hover:bg-foreground/90 transition-colors inline-flex items-center gap-2">
            ...
            <TabsContent value="security" className="space-y-8 mt-8">
              ...
              <button className="px-8 py-3 bg-foreground text-background text-sm uppercase tracking-widest hover:bg-foreground/90 transition-colors">
                Update Password
              </button>
            </TabsContent>
